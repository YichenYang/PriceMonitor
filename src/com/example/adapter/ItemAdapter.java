	...
	*/
	...
	public View getView(int position, View convertView, ViewGroup parent){
		...
		if (i != null) {
			...
			TextView provider = (TextView) v.findViewById(R.id.thirdLine);
			...
			if (provider != null){
				provider.setText(i.getAttributes().get(1).getValue().toString());
			}
		}
